    ...
    return {
      ...
      data: {
        ...
        user: {
          username: "Sehun",
          roles: ["admin"],
          photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTngUqCEiQThF5cMxKt-aWvZIo5mNhpXhSOeg&s",
          address: 'Korea'
        },
        menulist
      }
    ...
    return {
      ...
      data: {
        ...
        user: {
          username: "Lay",
          roles: ["user"],
          photo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTz6DhxcdrILxKc79_hne8FhUP9w1SwjrrQ3Q&s",
          address: 'China'
        },
        menulist: menulist2
      }
...
Mock.mock("https://www.demo.com/chartData3", 'get', () => {
  return {
    ...
    data: {
      ...
      list: [
        { name: "充电桩", data: [20, 50, 30, 70, 60, 80] },
        { name: "充电站", data: [40, 60, 50, 80, 70, 90] },
        { name: "充电杆", data: [30, 20, 10, 60, 60, 70] },
      ]
    }
  };
})
