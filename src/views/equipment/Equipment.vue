<template>
    <el-card>
        <el-row :gutter="20">
            <el-col :span="6">
                <el-input v-model="searchParams.no" placeholder="请输入会员卡号" size="normal" clearable></el-input>
            </el-col>
            <el-col :span="6">
                <el-input v-model="searchParams.tel" placeholder="请输入手机号" size="normal" clearable></el-input>
            </el-col>
            <el-col :span="6">
                <el-input v-model="searchParams.name" placeholder="请输入姓名" size="normal" clearable></el-input>
            </el-col>
            <el-col :span="6">
                ...
                <template #default="scope">
                    <el-popover placement="top-start" title="消费记录" :width="200" trigger="hover"
                        ...
                        <el-timeline style="max-width: 600px">
                            <el-timeline-item color="pink" v-for="(activity, index) in scope.row.transactionRecords"
                                :key="index" :timestamp="activity.transactionDate">
...
const {
    ...
    handleSizeChange,
    handleCurrentChange,
    resetPagination } = useHttp('/member', searchParams)
